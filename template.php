...
<head>
  ...
  <title>Inventori SMK Pesantren</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url()?>assets/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Inventori</b>SMK</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        DAFTAR BARANG LAB COE (Center of Excellent)
        <small>SMK PESANTREN CIWARINGIN KAMPUS 2</small>
      </h1>
      <!-- Button trigger modal -->
<div class="row mt-4">
    <div class="col-md-8">
      <a href="<?= base_url('barang/tambah'); ?>" class="btn btn-primary">Tambahkan Menu Makanan Lainnya</a>
  </div>
